...
const commands: Record<string, () => string[]> = {
  ...
  about: () => [
    "Hi, I'm Jonathan Zietsman, a full-stack software engineer from Durban with a passion for building web applications.",
    'I enjoy working with modern web technologies like Next.js, tRPC, and Prisma, and creating user-friendly experiences. This portfolio is styled like VS Code',
    'RELAX...It has zero red squiggly lines.',
  ],
  skills: () => [
    'Technical Skills:',
    '  Languages:  TypeScript, JavaScript, Python, HTML5, CSS3, SQL, Bash, JSON, Markdown, YAML, XML, GraphQL, ',
    '  Frontend:   React, Next.js, Tailwind CSS, Redux, React Query, tRPC, Material-UI, Bootstrap, Styled Components',
    '  Backend:    Node.js, Express, FastAPI, GraphQL, REST APIs, WebSockets, JWT Authentication, OAuth',
    '  Database:   PostgreSQL, MongoDB, MySQL, SQLite, Prisma, Mongoose',
    '  DevOps:     Docker, AWS, GitHub Actions, CI/CD',
    '  Tools:      VS Code, Git, Figma, Postman, Windows, Android, IOS, Notion, Webpack, ESLint, Prettier, Microsoft Suite, Google Workspace, Premeire Pro, After Effects, Blender, OBS Studio, Canva',
  ],
  projects: () => [
    'Featured Projects:',
    '  1. apexpos - A point-of-sale system for running a shop.',
    '  2. itHelpDesk - A help desk application for managing support tickets.',
    '  3. vscode-portfolio - This portfolio website, styled like VS Code.',
    '',
    'Visit the Projects tab for more details.',
  ],
  contact: () => [
    'Contact Information:',
    '  Email:    jonathanzietsman@gmail.com',
    '  GitHub:   https://github.com/jonathanzietsman',
    '  Twitter:  oneday',
    '  LinkedIn: incoming...',
  ],
  themes: () => [
